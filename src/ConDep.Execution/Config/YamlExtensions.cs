...
namespace ConDep.Execution.Config
{
  internal static class YamlExtensions
  {
    ...
    private static void FindNodesToEncrypt(YamlMappingNode container,
      List<KeyValuePair<YamlMappingNode, YamlNode>> matches)
    {
    ...
    private static void FindNodes(YamlMappingNode container, string name,
      List<KeyValuePair<YamlMappingNode, YamlNode>> matches)
    {
