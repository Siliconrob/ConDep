...
namespace ConDep.Dsl
{
  public interface IOfferOperations
  {
    ...
    IOfferOperations LoadBalance(LoadBalancerMode mode, string farm,
    ...
    IOfferOperations LoadBalance(LoadBalancerMode mode, Tier tier, string farm,
      Action<IOfferRemoteOperations, ServerConfig> remote);

    IOfferOperations LoadBalance(LoadBalancerMode mode, string tier, string farm,
