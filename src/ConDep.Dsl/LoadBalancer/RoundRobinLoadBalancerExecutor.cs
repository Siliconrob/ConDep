...
namespace ConDep.Dsl.LoadBalancer
{
  public class RoundRobinLoadBalancerExecutor : LoadBalancerExecutorBase
  {
    ...
    public override IEnumerable<ServerConfig> GetServerExecutionOrder(List<ServerConfig> servers,
    ...
    private void TurnRoundRobinServersAround(List<ServerConfig> servers, ConDepSettings settings,
      CancellationToken token, int roundRobinMaxOfflineServers)
    {
