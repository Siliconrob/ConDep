...
namespace ConDep.Dsl.Logging
{
  public abstract class Log4NetLoggerBase : LoggerBase
  {
    ...
    public override TraceLevel TraceLevel
    {
      get
      {
        if (((log4net.Repository.Hierarchy.Logger) _log4netLog.Logger).Level.Name == Level.Debug.Name)
          return TraceLevel.Verbose;
        if (((log4net.Repository.Hierarchy.Logger) _log4netLog.Logger).Level.Name == Level.Warn.Name)
          return TraceLevel.Warning;
        if (((log4net.Repository.Hierarchy.Logger) _log4netLog.Logger).Level.Name == Level.Info.Name)
          return TraceLevel.Info;
        if (((log4net.Repository.Hierarchy.Logger) _log4netLog.Logger).Level.Name == Level.Error.Name)
          return TraceLevel.Error;
        if (((log4net.Repository.Hierarchy.Logger) _log4netLog.Logger).Level.Name == Level.Off.Name)
