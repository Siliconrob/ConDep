...
namespace ConDep.Dsl.Remote.Node
{
  public class MultipartSyncDirContent : MultipartContent
  {
    ...
    public void Add(HttpContent content, string name, string fileName, FileAttributes attributes,
      DateTime lastWriteTimeUtc)
    {
      if (content.Headers.ContentDisposition == null)
      {
        ...
        parameters.Add(new NameValueHeaderValue("lastWriteTimeUtc",
          lastWriteTimeUtc.ToFileTime().ToString(CultureInfo.InvariantCulture)));
      }
