...
namespace ConDep.Dsl.Remote.Node.Model
{
  public class SyncDirDiff
  {
    ...
    public IEnumerable<SyncPath> DeletedFiles
    {
      get { return DeletedPaths.Where(x => x.IsDirectory == false); }
    }

    public IEnumerable<SyncPath> DeletedDirectories
    {
      get { return DeletedPaths.Where(x => x.IsDirectory); }
    }
