...
namespace ConDep.Dsl.Remote.Node.Model
{
  public static class DirectoryInfoExtensions
  {
    ...
    private static IEnumerable<SyncPath> GetAllRelativeFilePaths(this DirectoryInfo dirInfo, string rootPath,
      bool isRoot = true)
    {
      ...
      paths.AddRange(dirInfo.GetFiles()
        .Select(file => new SyncPath(file.FullName, rootPath, file.Attributes.ToString())));
