...
namespace ConDep.Dsl
{
  public class OperationsBuilder : IOfferOperations
  {
    ...
    public OperationsBuilder(int serial, ConDepSettings settings, ILookupLoadBalancer loadBalancerLocator,
    ...
    public IOfferOperations LoadBalance(LoadBalancerMode mode, string farm,
      Action<IOfferRemoteOperations, ServerConfig> remote)
    {
      return ExecuteRemoteWithLoadBalancer(mode, remote, _settings.Config.Servers.ToList(), farm);
    }

    public IOfferOperations LoadBalance(LoadBalancerMode mode, Tier tier, string farm,
      Action<IOfferRemoteOperations> remote)
    {
      return ExecuteRemoteWithLoadBalancer(mode, remote, _settings.Config.Servers.ToList(), farm);
    }
    ...
    public IOfferOperations LoadBalance(LoadBalancerMode mode, string tier, string farm,
      Action<IOfferRemoteOperations> remote)
    {
      return ExecuteRemoteWithLoadBalancer(mode, remote, _settings.Config.Servers.ToList(), farm);
    }
    ...
    private IOfferOperations ExecuteRemote(Action<IOfferRemoteOperations, ServerConfig> remote,
      IList<ServerConfig> servers)
    {
    ...
    private async Task<IOfferOperations> ExecuteRemoteAsync(Action<IOfferRemoteOperations, ServerConfig> remote,
      IList<ServerConfig> servers)
    {
      await Task.Run(() =>
      {
    ...
    private async Task<IOfferOperations> ExecuteRemoteAsync(Action<IOfferRemoteOperations> remote,
      IList<ServerConfig> servers)
    {
      await Task.Run(() =>
      {
    ...
    private IOfferOperations ExecuteRemoteWithLoadBalancer(LoadBalancerMode mode,
      Action<IOfferRemoteOperations, ServerConfig> remote, List<ServerConfig> servers, string farm)
    {
    ...
    private IOfferOperations ExecuteRemoteWithLoadBalancer(LoadBalancerMode mode, Action<IOfferRemoteOperations> remote,
      List<ServerConfig> servers, string farm)
    {
      var lbExecutor = GetLoadBalancer(mode, servers);
