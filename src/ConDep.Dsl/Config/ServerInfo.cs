...
namespace ConDep.Dsl.Config
{
  ...
  public class ServerInfo
  {
    ...
    public string ConDepScriptsFolder => string.IsNullOrWhiteSpace(TempFolderPowerShell)
      ? string.Empty
      : Path.Combine(TempFolderPowerShell, RELATIVE_CONDEP_SCRIPTS_FOLDER);

    public string ConDepScriptsFolderDos => string.IsNullOrWhiteSpace(TempFolderDos)
      ? string.Empty
      : Path.Combine(TempFolderDos, RELATIVE_CONDEP_SCRIPTS_FOLDER);

    public string ConDepNodeScriptsFolder => string.IsNullOrWhiteSpace(TempFolderPowerShell)
      ? string.Empty
      : Path.Combine(TempFolderPowerShell, RELATIVE_CONDEPNODE_SCRIPTS_FOLDER);
