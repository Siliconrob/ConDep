...
namespace ConDep.Console.Relay
{
  public class CmdRelayHandler : IHandleConDepCommands
  {
    ...
    public CmdRelayHandler(string[] args)
    {
      ...
      HelpWriter = new CmdRelayHelpWriter(System.Console.Out);
    }
    ...
    {
      HelpWriter.WriteHelp(_relayParser.OptionSet, _deployParser.OptionSet);
    }
    ...
    public CmdHelpWriter HelpWriter { get; }
