...
namespace ConDep.Console.Encrypt
{
  ...
  {
    private readonly ConDepEncryptOptions _options;
    ...
    public CmdEncryptParser(string[] args) : base(args)
    {
      ...
      _optionSet = new OptionSet
      {
        {
          "e=|env=",
          "Environment file to encrypt. Default is all. Valid options are All or spesific environment like dev.",
          v => _options.Env = v
        },
        {
          "d=|dir=",
        ...
        {
          "k=|key=",
          "Optional key to use for encryption. If not provided, a key will be generated and returned for your convenience. Keep key secure since it's needed for deployment and decryption.",
          v => _options.Key = v
        },
